...
export default function Index({ users = [] }) {
    ...
    return (
        <MainLayout title="Pengguna (RBAC)">
            <Head title="Kelola Pengguna & Hak Akses (RBAC)" />
            ...
            <div className="max-w-6xl mx-auto space-y-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-4">
                    <div>
                        <h2 className="text-base font-extrabold text-slate-900 tracking-tight">KELOLA PENGGUNA & HAK AKSES (RBAC)</h2>
                        <p className="text-[10px] text-slate-500 font-semibold uppercase mt-0.5 tracking-wider">
                            Atur izin masuk tim IT, Admin operasional, dan Distributor logistik
                        </p>
                    </div>
